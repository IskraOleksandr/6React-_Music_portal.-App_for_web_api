...
class CreateMusicForm extends React.Component {
    constructor(props) {
        super(props);
        let videoName = '';
    ...
    validateVideoName(videoName) {
        return videoName.length > 3;
    }

    validateAlbum(album) {
        return album.length > 3;
    }
    ...
    componentDidMount() {
        axios({
            ...
            console.log('hhh' + this.state.styleOptions);
        ...
        axios({
            ...
            console.log('hhh' + this.state.singerOptions);
        }).catch(function (error) {
            alert(error);
        });
    }
    ...
    render() {
        ...
        return (
            <div className="dv1v" style={{'height': '650px'}}>
                <br/><br/><br/>
                <h1 id="h1AdEdMusic" className="h1_n">Добавление песни</h1>
